...
<form>
  ...
  <div class="form-group">
    ...
    <input type="text" name="date" class="form-control" id="inputAddress" placeholder="Date of  joined">
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="text" name ="phone" class="form-control" id="inputAddress2" placeholder="Phone No.">
  </div>
  <div class="form-group">
    ...
    <button type="submit" name ="submit"class="btn"><a href="memberdetails.php">Details</a></button>
</form>
<!-- Form end-->
