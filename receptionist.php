...
<form>
  ...
  <div class="form-group">
    ...
    <input type="text" name ="date" class="form-control" id="inputAddress2" placeholder="Date Of Birth">
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <button type="submit" name ="submit"class="btn"><a href="recepdetails.php">Details</a></button>
</form>
<!-- Form end-->
